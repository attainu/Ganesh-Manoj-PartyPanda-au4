                        ...
                        <div className="card mt-1 bg-light" style={{"border":"none"}}>
                            <div className="card-body" >
                                ...
                                <div className="d-flex flex-row flex-wrap justify-content-around mt-1">
                                    ...
                                    <div className="d-flex flex-column shadow col-md-5 border border-white bg-white mt-1 py-2 px-2" style={{"borderRadius":"35px"}}>
                                        <h3 className=" pt-1 pb-2 text-dark">Host</h3>
                                        
                                        <h5 className="pl-3" style={{"textAlign":"left"}}>Ayush Singh</h5>
                                        <p className="text-muted text-left pl-3 pt-3">Ex-IITian, aerospace engineer by profession and avid traveller 
                                         and explorer by passion, I'hv founded KarwaanJourney with the mission of introducing caravan
